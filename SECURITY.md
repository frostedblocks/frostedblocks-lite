...
- Security headers: CSP (enforce) with nonce + strict-dynamic; Safari fallbacks `https:` and `'unsafe-inline'` (ignored by browsers that honor nonces). HSTS 2 years without includeSubDomains, COOP, CORP, no ACAO *.
